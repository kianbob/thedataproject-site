        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <a href="https://www.openmedicaid.org" target="_blank" rel="noopener noreferrer"
              className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all group">
              <div className="text-3xl mb-4">🏥</div>
              <h3 className="text-xl font-bold text-gray-900 group-hover:text-teal-700 transition-colors">OpenMedicaid</h3>
              <p className="text-gray-500 mt-2">The most comprehensive open Medicaid data platform. Explore provider payments, utilization, and fraud detection insights across all 50 states.</p>
              <span className="inline-block mt-4 text-teal-700 text-sm font-medium">openmedicaid.org →</span>
            </a>
            <a href="https://www.donorsecrets.com" target="_blank" rel="noopener noreferrer"
              className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all group">
              <div className="text-3xl mb-4">🗳️</div>
              <h3 className="text-xl font-bold text-gray-900 group-hover:text-teal-700 transition-colors">DonorSecrets / Election Money Explorer</h3>
              <p className="text-gray-500 mt-2">Track 43M+ campaign contributions, political donors, spending, and follow the money in U.S. elections. Powered by FEC data.</p>
              <span className="inline-block mt-4 text-teal-700 text-sm font-medium">donorsecrets.com →</span>
            </a>
          </div>
        </div>
      </section>
