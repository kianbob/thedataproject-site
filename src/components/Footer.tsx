      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <a href="https://www.openmedicare.us" target="_blank" rel="noopener noreferrer" className="block text-gray-500 hover:text-teal-700 text-sm transition-colors">OpenMedicare</a>
              <a href="https://www.openlobby.us" target="_blank" rel="noopener noreferrer" className="block text-gray-500 hover:text-teal-700 text-sm transition-colors">OpenLobby</a>
              ...
              <a href="https://www.nbaawardstracker.com" target="_blank" rel="noopener noreferrer" className="block text-gray-500 hover:text-teal-700 text-sm transition-colors">NBA Awards Tracker</a>
            </div>
          </div>
          <div>
        ...
        <div className="mt-10 pt-8 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://www.instagram.com/thedataproject.ai" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-teal-700 transition-colors" aria-label="Instagram">
            ...
            <a href="https://www.facebook.com/people/Thedataprojectai/61577226522734/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-teal-700 transition-colors" aria-label="Facebook">
