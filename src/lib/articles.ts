...
export const articles: Article[] = [
  ...
  },
  {
    ...
    description: "We built TariffTax.org to answer a question Washington won't: who actually pays for tariffs? Hint — it's you. 279 pages of data tracking every US tariff, its real cost per household ($3,800–$4,900/year), and the biggest effective tax increase since 1972.",
    date: "2026-03-26",
    content: `
      <p style="font-size: 1.125rem; color: #4b5563; margin-bottom: 2rem;">Here's something that should be simple but somehow isn't: <strong>tariffs are taxes</strong>. They're not paid by China. They're not paid by Europe. They're paid by American importers, who pass the cost to American consumers, who pay more for everything from iPhones to washing machines to groceries. This isn't editorial opinion — it's what the data shows, overwhelmingly, across every serious economic study ever conducted. <a href="https://www.tarifftax.org" style="color: #0f766e; font-weight: 600;">TariffTax.org</a> is our platform for making that data impossible to ignore.</p>

      <div style="background-color: #111827; color: #ffffff; border-radius: 0.75rem; padding: 2rem; margin: 2rem 0;">
        <h2 style="font-size: 1.5rem; font-weight: 700; margin-bottom: 1.25rem; color: #ffffff;">The Tariff Tax Right Now</h2>
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; text-align: center;">
          <div><div style="font-size: 2rem; font-weight: 700; color: #f87171;">$3,800–$4,900</div><div style="font-size: 0.75rem; color: #9ca3af; margin-top: 0.25rem;">Cost Per Household/Year</div></div>
          ...
          <div><div style="font-size: 2rem; font-weight: 700; color: #f87171;">$287B</div><div style="font-size: 0.75rem; color: #9ca3af; margin-top: 0.25rem;">Projected 2025 Revenue</div></div>
          <div><div style="font-size: 2rem; font-weight: 700; color: #fbbf24;">304K</div><div style="font-size: 0.75rem; color: #9ca3af; margin-top: 0.25rem;">Jobs Affected</div></div>
          ...
          <div><div style="font-size: 2rem; font-weight: 700; color: #fbbf24;">Since 1789</div><div style="font-size: 0.75rem; color: #9ca3af; margin-top: 0.25rem;">Historical Coverage</div></div>
        </div>
      </div>

      <h2 style="font-size: 1.5rem; font-weight: 700; color: #111827; margin-top: 2.5rem; margin-bottom: 1rem;">The Thesis: You're Already Paying</h2>

      <p style="color: #374151; margin-bottom: 1rem;">Politicians love tariffs because they're invisible. Unlike income taxes or sales taxes, you never see a line item on your receipt that says "tariff surcharge: $47." The cost is baked into the price. Your washing machine costs $150 more. Your car costs $2,000 more. Your groceries creep up a few dollars every week. You pay, but you don't <em>see</em> yourself paying — and that's exactly how both parties like it.</p>

      <p style="color: #374151; margin-bottom: 1rem;">Republicans use tariffs for trade wars. Democrats use them for industrial policy. Both claim the other country is "paying." Neither is telling the truth. The customs duties are paid at the border by <strong>American importers</strong>, and study after study — from the Fed, from the Tax Foundation, from academic economists left and right — confirms that nearly 100% of the cost is passed through to consumers. <a href="https://www.tarifftax.org" style="color: #0f766e; font-weight: 600;">TariffTax.org</a> exists to show you exactly how much.</p>

      <h2 style="font-size: 1.5rem; font-weight: 700; color: #111827; margin-top: 2.5rem; margin-bottom: 1rem;">What's on the Platform</h2>
      ...
      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem; margin: 1.5rem 0;">
        ...
        <a href="https://www.tarifftax.org/countries" style="display: block; background: #f0fdfa; border: 1px solid #99f6e4; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none;">
          ...
          <div style="font-size: 0.875rem; color: #6b7280;">Trade relationships, tariff rates, retaliation tracking, and what each country actually exports to the US</div>
        </a>
        ...
        <a href="https://www.tarifftax.org/calculator" style="display: block; background: #f0fdfa; border: 1px solid #99f6e4; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none;">
          ...
          <div style="font-size: 0.875rem; color: #6b7280;">Enter your household details and see YOUR tariff bill — the hidden tax you're already paying</div>
        </a>
        <a href="https://www.tarifftax.org/effective-rate" style="display: block; background: #f0fdfa; border: 1px solid #99f6e4; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none;">
          ...
          <div style="font-size: 0.875rem; color: #6b7280;">Currently the highest since 1972. Watch it move in real time as new tariffs take effect.</div>
        </a>
        <a href="https://www.tarifftax.org/timeline" style="display: block; background: #f0fdfa; border: 1px solid #99f6e4; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none;">
          <div style="font-size: 1.5rem; margin-bottom: 0.5rem;">📜</div>
          <div style="font-weight: 600; color: #0f766e;">Tariff Timeline (1789–Present)</div>
          <div style="font-size: 0.875rem; color: #6b7280;">From Hamilton's first tariff to today's trade wars — 237 years of America taxing its own consumers</div>
        </a>
        <a href="https://www.tarifftax.org/analysis" style="display: block; background: #f0fdfa; border: 1px solid #99f6e4; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none;">
          <div style="font-size: 1.5rem; margin-bottom: 0.5rem;">📝</div>
          <div style="font-weight: 600; color: #0f766e;">22 Deep Analysis Articles</div>
          <div style="font-size: 0.875rem; color: #6b7280;">IEEPA constitutional crisis, Smoot-Hawley parallels, who really pays, and the retaliation spiral</div>
        </a>
      </div>

      <h2 style="font-size: 1.5rem; font-weight: 700; color: #111827; margin-top: 2.5rem; margin-bottom: 1rem;">The Constitutional Crisis Nobody's Talking About</h2>

      <p style="color: #374151; margin-bottom: 1rem;">Here's something that should worry everyone regardless of party: the current tariff regime is being imposed under the <strong>International Emergency Economic Powers Act (IEEPA)</strong> — a 1977 law designed for actual national emergencies like freezing terrorist assets. It was never intended to impose sweeping import taxes on allied nations. Multiple federal courts have flagged this. The constitutional question — whether the president can unilaterally impose taxes that Article I of the Constitution reserves to Congress — is heading to the Supreme Court. <a href="https://www.tarifftax.org" style="color: #0f766e; font-weight: 600;">TariffTax.org</a> tracks this legal battle in real time.</p>

      <h2 style="font-size: 1.5rem; font-weight: 700; color: #111827; margin-top: 2.5rem; margin-bottom: 1rem;">By the Numbers: What Tariffs Actually Cost You</h2>

      <div style="background-color: #111827; color: #ffffff; border-radius: 0.75rem; padding: 2rem; margin: 2rem 0;">
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem;">
          <div style="background: rgba(255,255,255,0.05); border-radius: 0.5rem; padding: 1.25rem;">
            <div style="font-size: 0.75rem; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.05em;">Your iPhone</div>
            <div style="font-size: 1.5rem; font-weight: 700; color: #f87171; margin-top: 0.25rem;">+$200–$300</div>
          </div>
          <div style="background: rgba(255,255,255,0.05); border-radius: 0.5rem; padding: 1.25rem;">
            <div style="font-size: 0.75rem; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.05em;">Your Car</div>
            <div style="font-size: 1.5rem; font-weight: 700; color: #f87171; margin-top: 0.25rem;">+$2,000–$4,000</div>
          </div>
          <div style="background: rgba(255,255,255,0.05); border-radius: 0.5rem; padding: 1.25rem;">
            <div style="font-size: 0.75rem; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.05em;">Your Washing Machine</div>
            <div style="font-size: 1.5rem; font-weight: 700; color: #f87171; margin-top: 0.25rem;">+$80–$150</div>
          </div>
          <div style="background: rgba(255,255,255,0.05); border-radius: 0.5rem; padding: 1.25rem;">
            <div style="font-size: 0.75rem; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.05em;">Your Groceries (Annual)</div>
            <div style="font-size: 1.5rem; font-weight: 700; color: #f87171; margin-top: 0.25rem;">+$400–$800</div>
          </div>
        </div>
      </div>

      <p style="color: #374151; margin-bottom: 1rem;">The effective tariff rate — total duties collected divided by total imports — is now the highest it's been since <strong>1972</strong>. The US is projected to collect <strong>$287 billion</strong> in tariff revenue in 2025. That's $287 billion taken from American consumers and businesses, laundered through the customs system, and deposited in the Treasury. It's a tax. Call it what it is.</p>

      <p style="color: #374151; margin-bottom: 1rem;">And the jobs math doesn't work either. While tariffs are pitched as protecting American workers, the data shows <strong>304,000 jobs affected</strong> — and not all in the direction you'd expect. For every steel job "saved" by steel tariffs, multiple jobs are lost in industries that <em>use</em> steel. The washing machine tariffs created about 1,800 manufacturing jobs at a cost of roughly $817,000 per job — paid by consumers through higher prices.</p>

      <h2 style="font-size: 1.5rem; font-weight: 700; color: #111827; margin-top: 2.5rem; margin-bottom: 1rem;">Why We Built This</h2>

      <p style="color: #374151; margin-bottom: 1rem;">We're not anti-trade and we're not pro-trade. We're pro-transparency. If the government wants to tax you, it should have to call it a tax. If a policy costs your household $4,000 a year, you should be able to see that number. If retaliatory tariffs are killing soybean exports in Iowa, Iowa voters should know. If the constitutional basis for these tariffs is shaky, citizens should understand what's at stake.</p>

      <p style="color: #374151; margin-bottom: 1rem;">The editorial angle is simple: <strong>show the data, follow the money, name the cost.</strong> We think most Americans — left, right, libertarian, whatever — would object to a $4,000 hidden tax if they could see it. TariffTax makes it visible.</p>

      <p style="color: #374151; margin-bottom: 1rem;"><a href="https://www.tarifftax.org" style="color: #0f766e; font-weight: 600;">TariffTax.org</a> joins TheDataProject's portfolio alongside <a href="https://www.spacgraveyard.com" style="color: #0f766e;">SPACGraveyard</a>, <a href="https://www.warcosts.org" style="color: #0f766e;">WarCosts</a>, <a href="https://www.openmedicare.us" style="color: #0f766e;">OpenMedicare</a>, <a href="https://www.opencrime.us" style="color: #0f766e;">OpenCrime</a>, and 10 other public data platforms. Every tariff is a tax. Now you can see who pays.</p>

      <div style="background-color: #0f766e; color: #ffffff; border-radius: 0.75rem; padding: 2rem; margin: 2rem 0; text-align: center;">
        <p style="font-size: 1.25rem; font-weight: 700; margin-bottom: 0.75rem;">Explore TariffTax.org</p>
        <p style="font-size: 0.875rem; margin-bottom: 1.25rem; opacity: 0.9;">80 Products · 30 Countries · 51 States · 20 Industries · Household Calculator · Tariff Timeline · 22 Analysis Articles</p>
        <a href="https://www.tarifftax.org" style="display: inline-block; background: #ffffff; color: #0f766e; font-weight: 700; padding: 0.75rem 2rem; border-radius: 0.5rem; text-decoration: none; font-size: 1rem;">Visit TariffTax.org →</a>
      </div>
    `,
  },
  {
  ...
  },
  {
    ...
    date: "2026-03-06",
    content: `
      <p style="font-size: 1.125rem; color: #4b5563; margin-bottom: 2rem;">We built <a href="https://www.warcosts.org" style="color: #0f766e; font-weight: 600;">WarCosts.org</a> because no one else puts all the data in one place. Not the Pentagon. Not Congress. Not the media. The human and financial costs of American wars are scattered across thousands of reports, buried in footnotes, or simply never tallied. WarCosts is our newest platform — and it tracks every dollar and every life, from the American Revolution through today.</p>

      <div style="background-color: #111827; color: #ffffff; border-radius: 0.75rem; padding: 2rem; margin: 2rem 0;">
        <h2 style="font-size: 1.5rem; font-weight: 700; margin-bottom: 1.25rem; color: #ffffff;">The Numbers Right Now</h2>
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; text-align: center;">
          <div><div style="font-size: 2rem; font-weight: 700; color: #f87171;">$28,095/sec</div><div style="font-size: 0.75rem; color: #9ca3af; margin-top: 0.25rem;">U.S. Military Spending</div></div>
          <div><div style="font-size: 2rem; font-weight: 700; color: #f87171;">469</div><div style="font-size: 0.75rem; color: #9ca3af; margin-top: 0.25rem;">Military Interventions</div></div>
          <div><div style="font-size: 2rem; font-weight: 700; color: #f87171;">17/day</div><div style="font-size: 0.75rem; color: #9ca3af; margin-top: 0.25rem;">Veteran Suicides</div></div>
          <div><div style="font-size: 2rem; font-weight: 700; color: #f87171;">$1.7T</div><div style="font-size: 0.75rem; color: #9ca3af; margin-top: 0.25rem;">F-35 Lifetime Cost</div></div>
          <div><div style="font-size: 2rem; font-weight: 700; color: #f87171;">250 years</div><div style="font-size: 0.75rem; color: #9ca3af; margin-top: 0.25rem;">Of Conflicts Covered</div></div>
          <div><div style="font-size: 2rem; font-weight: 700; color: #f87171;">$886B</div><div style="font-size: 0.75rem; color: #9ca3af; margin-top: 0.25rem;">FY2025 Defense Budget</div></div>
        </div>
      </div>

      <h2 style="font-size: 1.5rem; font-weight: 700; color: #111827; margin-top: 2.5rem; margin-bottom: 1rem;">Why This Exists</h2>

      <p style="color: #374151; margin-bottom: 1rem;">The Iraq and Afghanistan wars cost $8 trillion over 20 years. Most Americans never saw a running tally. The Pentagon doesn't publish one. Congress doesn't either. By the time the costs are tallied, the war is over and the debate has moved on.</p>

      <p style="color: #374151; margin-bottom: 1rem;"><a href="https://www.warcosts.org" style="color: #0f766e; font-weight: 600;">WarCosts.org</a> joins TheDataProject's portfolio of public data platforms — alongside <a href="https://www.openmedicare.us" style="color: #0f766e;">OpenMedicare</a>, <a href="https://www.openmedicaid.org" style="color: #0f766e;">OpenMedicaid</a>, <a href="https://www.opencrime.us" style="color: #0f766e;">OpenCrime</a>, and others — with a singular focus: making the cost of war visible, in real time, down to the second. We think Americans deserve to see what their wars actually cost while they're still happening.</p>

      <h2 style="font-size: 1.5rem; font-weight: 700; color: #111827; margin-top: 2.5rem; margin-bottom: 1rem;">What's on the Platform</h2>

      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem; margin: 1.5rem 0;">
        <a href="https://www.warcosts.org/war-clock" style="display: block; background: #f0fdfa; border: 1px solid #99f6e4; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none;">
          <div style="font-weight: 700; color: #0f766e; margin-bottom: 0.25rem;">⏱ War Clock</div>
          <div style="font-size: 0.875rem; color: #4b5563;">A real-time cost ticker showing U.S. military spending as it happens — $28,095 every second, $2.4 billion every day</div>
        </a>
        <a href="https://www.warcosts.org/conflicts" style="display: block; background: #f0fdfa; border: 1px solid #99f6e4; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none;">
          <div style="font-weight: 700; color: #0f766e; margin-bottom: 0.25rem;">📊 Every U.S. Conflict</div>
          <div style="font-size: 0.875rem; color: #4b5563;">Data on every American war and military intervention — from the Revolution (1775) through Iran (2026). Costs, casualties, duration, and outcomes</div>
        </a>
        <a href="https://www.warcosts.org/tools/tax-receipt" style="display: block; background: #f0fdfa; border: 1px solid #99f6e4; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none;">
          <div style="font-weight: 700; color: #0f766e; margin-bottom: 0.25rem;">🧾 Tax Receipt Calculator</div>
          <div style="font-size: 0.875rem; color: #4b5563;">Enter your income and see exactly how much of your taxes fund the military — broken down by weapons systems, personnel, and operations</div>
        </a>
        <a href="https://www.warcosts.org/tools/jobs-calculator" style="display: block; background: #f0fdfa; border: 1px solid #99f6e4; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none;">
          <div style="font-weight: 700; color: #0f766e; margin-bottom: 0.25rem;">💼 Jobs Calculator</div>
          <div style="font-size: 0.875rem; color: #4b5563;">What if military spending went to infrastructure, healthcare, or education instead? See the job creation comparison</div>
        </a>
        <a href="https://www.warcosts.org/cost-per-life" style="display: block; background: #f0fdfa; border: 1px solid #99f6e4; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none;">
          <div style="font-weight: 700; color: #0f766e; margin-bottom: 0.25rem;">💀 Cost Per Life Rankings</div>
          <div style="font-size: 0.875rem; color: #4b5563;">The most chilling metric: how much America spent per life lost in each conflict. The numbers vary wildly — and they tell a story</div>
        </a>
        <a href="https://www.warcosts.org/presidents" style="display: block; background: #f0fdfa; border: 1px solid #99f6e4; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none;">
          <div style="font-weight: 700; color: #0f766e; margin-bottom: 0.25rem;">🏛 President Scorecards</div>
          <div style="font-size: 0.875rem; color: #4b5563;">Every president ranked by military spending, wars started, troops deployed, and lives lost under their watch</div>
        </a>
      </div>

      <a href="https://www.warcosts.org/analysis" style="display: block; background: #f0fdfa; border: 1px solid #99f6e4; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none; margin-bottom: 1.5rem;">
        <div style="font-weight: 700; color: #0f766e; margin-bottom: 0.25rem;">📝 Analysis Articles</div>
        <div style="font-size: 0.875rem; color: #4b5563;">Deep-dive investigations into the costs of specific conflicts, weapons programs, and military policy — data-driven, fully sourced</div>
      </a>

      <h2 style="font-size: 1.5rem; font-weight: 700; color: #111827; margin-top: 2.5rem; margin-bottom: 1rem;">The Scope: 250 Years of American War</h2>

      <p style="color: #374151; margin-bottom: 1rem;">WarCosts doesn't just cover the headlines. The <a href="https://www.warcosts.org/conflicts" style="color: #0f766e; font-weight: 600;">conflicts database</a> spans every major U.S. military engagement — the Revolutionary War, the Civil War, both World Wars, Korea, Vietnam, the Gulf War, Iraq, Afghanistan, and now Iran 2026. It also covers the interventions most Americans have never heard of: 469 military interventions across the globe, many undeclared, many forgotten.</p>

      <p style="color: #374151; margin-bottom: 1rem;">For each conflict you get costs (adjusted for inflation), casualties on all sides, duration, troop deployments, and long-term consequences including veteran care costs that extend decades beyond the last shot fired. The <a href="https://www.warcosts.org/presidents" style="color: #0f766e; font-weight: 600;">president scorecards</a> tie it all together — showing which administrations drove military expansion and at what human cost.</p>

      <h2 style="font-size: 1.5rem; font-weight: 700; color: #111827; margin-top: 2.5rem; margin-bottom: 1rem;">The Tools: Make It Personal</h2>

      <p style="color: #374151; margin-bottom: 1rem;">Data is powerful, but it's more powerful when it's personal. The <a href="https://www.warcosts.org/tools/tax-receipt" style="color: #0f766e; font-weight: 600;">Tax Receipt calculator</a> shows you exactly how your tax dollars break down across the military budget. The <a href="https://www.warcosts.org/tools/jobs-calculator" style="color: #0f766e; font-weight: 600;">Jobs calculator</a> shows what those same dollars could have created if invested in infrastructure, healthcare, education, or clean energy instead. The <a href="https://www.warcosts.org/cost-per-life" style="color: #0f766e; font-weight: 600;">Cost Per Life rankings</a> put a dollar figure on every life lost in every conflict — a metric that's uncomfortable by design.</p>

      <div style="background-color: #111827; color: #ffffff; border-radius: 0.75rem; padding: 2rem; margin: 2rem 0;">
        <h2 style="font-size: 1.5rem; font-weight: 700; margin-bottom: 1.25rem; color: #ffffff;">Current Highlight: Iran 2026 — Week One</h2>
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; text-align: center;">
      ...
      <p style="color: #374151; margin-bottom: 1rem;">On February 28, 2026, the United States launched airstrikes against Iran. Seven days in, the costs are staggering — and climbing by the second. This is exactly the kind of conflict WarCosts was built for: a war where the costs escalate faster than the public can track them, and where the true price won't be known for decades.</p>

      <p style="color: #374151; margin-bottom: 1rem;">We've published six in-depth analysis articles covering every dimension of the Iran conflict, with live data updates:</p>

      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem; margin: 1.5rem 0;">
        <a href="https://www.warcosts.org/analysis/iran-2026" style="display: block; background: #fef2f2; border: 1px solid #fecaca; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none;">
          <div style="font-weight: 700; color: #991b1b; margin-bottom: 0.25rem;">Iran 2026: Full Analysis</div>
          <div style="font-size: 0.875rem; color: #4b5563;">Comprehensive overview — timeline, costs, casualties, and geopolitical impact</div>
        </a>
        <a href="https://www.warcosts.org/analysis/iran-cost-per-second" style="display: block; background: #fef2f2; border: 1px solid #fecaca; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none;">
          <div style="font-weight: 700; color: #991b1b; margin-bottom: 0.25rem;">Cost Per Second</div>
          <div style="font-size: 0.875rem; color: #4b5563;">Real-time cost ticker — what America spends every second on this war</div>
        </a>
        <a href="https://www.warcosts.org/analysis/iran-civilian-cost" style="display: block; background: #fef2f2; border: 1px solid #fecaca; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none;">
          <div style="font-weight: 700; color: #991b1b; margin-bottom: 0.25rem;">The Civilian Cost</div>
          <div style="font-size: 0.875rem; color: #4b5563;">Civilian casualties, displacement, and humanitarian impact</div>
        </a>
        <a href="https://www.warcosts.org/analysis/iran-regional-war" style="display: block; background: #fef2f2; border: 1px solid #fecaca; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none;">
          <div style="font-weight: 700; color: #991b1b; margin-bottom: 0.25rem;">The Regional War</div>
      ...
      <a href="https://www.warcosts.org/analysis/iran-russia-shadow-war" style="display: block; background: #fef2f2; border: 1px solid #fecaca; border-radius: 0.5rem; padding: 1.25rem; text-decoration: none; margin-bottom: 1.5rem;">
        ...
        <div style="font-size: 0.875rem; color: #4b5563;">Russian involvement — arms transfers, satellite data sharing, and economic positioning</div>
      </a>
      ...
      <p style="color: #374151; margin-bottom: 1rem;">That's what <a href="https://www.warcosts.org" style="color: #0f766e; font-weight: 600;">WarCosts.org</a> does. Every dollar. Every life. Every war. From 1775 to right now. Because the cost of war shouldn't be an afterthought — it should be visible from day one.</p>

      <div style="background-color: #0f766e; color: #ffffff; border-radius: 0.75rem; padding: 2rem; margin: 2rem 0; text-align: center;">
        <p style="font-size: 1.25rem; font-weight: 700; margin-bottom: 0.75rem;">Explore WarCosts.org</p>
        <p style="font-size: 0.875rem; margin-bottom: 1.25rem; opacity: 0.9;">War Clock · Every U.S. Conflict · Tax Receipt Calculator · Jobs Calculator · Cost Per Life · President Scorecards · Iran 2026 Live Coverage</p>
      ...
      <p style="color: #6b7280; font-size: 0.875rem; font-style: italic; margin-top: 2rem;">WarCosts.org is built by <a href="/" style="color: #0f766e;">TheDataProject.AI</a>. Cost estimates are based on publicly available DoD spending data, historical per-unit costs, Congressional Research Service reports, and open-source intelligence. Casualty figures are compiled from official records, credible media reports, and humanitarian organizations. All figures are estimates and are updated as better data becomes available.</p>
    `
  },
  {
    ...
    content: `
      ...
      <div class="grid md:grid-cols-3 gap-4 my-8">
        <div class="bg-teal-50 border border-teal-200 rounded-lg p-5">
          <h3 class="font-bold text-teal-800 mb-2"><a href="https://www.openmedicare.us" class="hover:underline">OpenMedicare</a></h3>
          <ul class="text-sm text-gray-700 space-y-1">
            <li>• Bagged Decision Trees</li>
            <li>• Trained on <strong>2,198</strong> LEIE+DOJ confirmed fraudsters</li>
            <li>• AUC: 0.83</li>
            <li>• <strong>500</strong> "still out there" flagged</li>
            <li>• <a href="https://www.openmedicare.us/investigations/algorithm-knows" class="text-teal-700 hover:underline">How we built the model →</a></li>
          </ul>
        </div>
        <div class="bg-teal-50 border border-teal-200 rounded-lg p-5">
          <h3 class="font-bold text-teal-800 mb-2"><a href="https://www.openprescriber.org" class="hover:underline">OpenPrescriber</a></h3>
          <ul class="text-sm text-gray-700 space-y-1">
            <li>• Bagged Decision Trees (20 trees)</li>
            <li>• Trained on <strong>281</strong> LEIE-confirmed fraud cases</li>
            <li>• 83% precision, 66.6% recall</li>
            <li>• <strong>4,183</strong> flagged at ≥80% confidence</li>
            <li>• <a href="https://www.openprescriber.org/ml-fraud-detection" class="text-teal-700 hover:underline">Full methodology →</a></li>
          </ul>
        </div>
        <div class="bg-teal-50 border border-teal-200 rounded-lg p-5">
      ...
      <p class="text-gray-700 mb-4">He is board-certified, serves as Chairman and Medical Director of Psychiatry at South City Hospital in St. Louis, and has over 17 years of experience. He is affiliated with Mercy Hospital St. Louis and SSM Health DePaul Hospital. He has not been charged with any crime.</p>
      ...
      <p class="text-sm mb-4"><a href="https://www.openprescriber.org/providers/1104916907" class="text-teal-700 hover:underline">View on OpenPrescriber →</a></p>
      <div class="bg-gray-50 rounded-lg p-6 mb-6">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
      ...
      <p class="text-sm mb-4"><a href="https://www.openprescriber.org/providers/1316108269" class="text-teal-700 hover:underline">View on OpenPrescriber →</a></p>
      <div class="bg-gray-50 rounded-lg p-6 mb-6">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
      ...
      <div class="bg-gray-50 rounded-lg p-6 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          <div>
            ...
            <div class="text-sm text-gray-500 mb-2">Medicare providers flagged</div>
            <a href="https://www.openmedicare.us/fraud/still-out-there" class="text-teal-700 hover:underline text-sm font-medium">Browse the full list →</a>
          </div>
          <div>
            <div class="text-3xl font-bold text-gray-900">4,183</div>
            <div class="text-sm text-gray-500 mb-2">Prescribers flagged (≥80%)</div>
      ...
      <div class="grid md:grid-cols-3 gap-4 mb-8">
        <a href="https://www.openmedicare.us/fraud" class="block bg-gray-50 border border-gray-200 rounded-lg p-5 hover:shadow-md transition">
          <h3 class="font-bold text-gray-900 mb-1">OpenMedicare Fraud Hub</h3>
          <p class="text-sm text-gray-600 mb-2">500 ML-flagged providers, searchable by state and specialty</p>
          <span class="text-teal-700 text-sm font-medium">Explore →</span>
        </a>
        <a href="https://www.openprescriber.org/ml-fraud-detection" class="block bg-gray-50 border border-gray-200 rounded-lg p-5 hover:shadow-md transition">
          <h3 class="font-bold text-gray-900 mb-1">OpenPrescriber ML Detection</h3>
          <p class="text-sm text-gray-600 mb-2">4,183 flagged prescribers with full methodology</p>
          <span class="text-teal-700 text-sm font-medium">Explore →</span>
        </a>
      ...
      <h3 class="text-lg font-bold text-gray-900 mb-3">Related Investigations on OpenMedicare</h3>
      <ul class="list-disc pl-6 space-y-2 text-gray-700 mb-6">
        <li><a href="https://www.openmedicare.us/investigations/algorithm-knows" class="text-teal-700 hover:underline">The Algorithm Knows</a> — How we built the ML model that found 500 unflagged providers</li>
        <li><a href="https://www.openmedicare.us/investigations/still-out-there" class="text-teal-700 hover:underline">500 Providers Still Billing Like Fraudsters</a> — The full investigation with searchable data</li>
        <li><a href="https://www.openmedicare.us/investigations/the-4636-impossible-doctors" class="text-teal-700 hover:underline">The 4,636 Impossible Doctors</a> — Providers billing for more services than hours in a day</li>
        <li><a href="https://www.openmedicare.us/investigations/medicare-fraud-statistics" class="text-teal-700 hover:underline">Medicare Fraud Statistics 2025</a> — The scale of healthcare fraud by the numbers</li>
        <li><a href="https://www.openmedicare.us/investigations/pain-management-fraud" class="text-teal-700 hover:underline">Pain Management Fraud</a> — The specialty at the center of the opioid crisis</li>
        <li><a href="https://www.openmedicare.us/investigations/million-dollar-flagged" class="text-teal-700 hover:underline">Million-Dollar Flagged</a> — Providers with 7-figure billing and high fraud scores</li>
        <li><a href="https://www.openmedicare.us/fraud/still-out-there" class="text-teal-700 hover:underline">Still Out There: Interactive Explorer</a> — Search all 500 flagged providers by state, specialty, and score</li>
        <li><a href="https://www.openmedicare.us/fraud/top-100" class="text-teal-700 hover:underline">Top 100 Suspicious Providers</a> — The highest-scoring providers ranked</li>
      </ul>

      <h3 class="text-lg font-bold text-gray-900 mb-3">Related on OpenPrescriber</h3>
      <ul class="list-disc pl-6 space-y-2 text-gray-700 mb-6">
        <li><a href="https://www.openprescriber.org/ml-fraud-detection" class="text-teal-700 hover:underline">ML Fraud Detection</a> — Full methodology, tier breakdown, and top 100 table</li>
        <li><a href="https://www.openprescriber.org/risk-explorer" class="text-teal-700 hover:underline">Risk Explorer</a> — 6,706 providers with elevated risk scores, searchable and filterable</li>
